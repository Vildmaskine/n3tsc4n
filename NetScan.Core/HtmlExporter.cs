...
public static class HtmlExporter
{
    public static string Generate(IEnumerable<ScanResult> results, string subnet, DateTime scannedAt)
    {
            ...
            *{ box-sizing:border-box; margin:0; padding:0; }
            ...
            <header>
              ...
              <div class="meta">
                ...
                <div>Scanned: <strong>{{scannedAt:dd. MMMM yyyy, HH:mm}}</strong></div>
              </div>
            </header>
            <main>
              <div class="stats">
                <div class="stat"><div class="lbl">Devices found</div><div class="val">{{rows.Count}}</div></div>
        ...
        sb.Append($$"""
            ...
            <footer>Generated by N3tSc4n · {{scannedAt:yyyy-MM-dd HH:mm}}</footer>
            </body>
            </html>
            """);
