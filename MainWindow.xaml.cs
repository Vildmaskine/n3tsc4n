...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        // Bind DataGrid med numerisk IP-sortering
        ...
        // Wire custom scrollbar (full height incl. headers) to DataGrid's internal ScrollViewer
        DGrid.Loaded += (_, _) =>
        {
            ...
            await Task.Run(async () =>
            {
                await foreach (var result in engine.ScanAsync(subnet, progress, ct))
                {
                    ...
                    await Dispatcher.InvokeAsync(() =>
                    {
                        ...
                        // Switch to indeterminate after ping phase completes
                        // (first result arrives = enrichment phase started)
    ...
    {
        // Switch maximize icon between □ (normal) and ❐ (restore)
        MaximizeIcon.Data = System.Windows.Media.Geometry.Parse(
            WindowState == WindowState.Maximized
                ? "M 3,0 L 12,0 L 12,9 L 3,9 Z M 0,3 L 9,3 L 9,12 L 0,12 Z"  // restore
                : "M 0,0 L 12,0 L 12,12 L 0,12 Z");                             // maximise
    }
